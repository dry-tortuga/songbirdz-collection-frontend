					...
					<Col>
						...
						<ul style={{ listStyle: 'disc' }}>
							<li>
								...
								<span className="ms-1">
									{"SOLD OUT: The first batch of 1,000 birds in the Songbirdz collection (0-999). Features 200 different species, with exactly 5 birds of each species."}
								</span>
							</li>
							<li>
								<a
								...
								<span className="ms-1">
									{"NOW MINTING: The second batch of 1,000 birds in the Songbirdz collection (1000-1999). Features 50 different species, with various amounts of birds per species of either 1, 5, 10, 20, 30 or 50. Includes 5 \"1 of 1\" birds that are the only one of their species!"}
								</span>
							</li>
						</ul>
					</Col>
