						...
						{users &&
							<>
								...
								<div className="text-center">
									{"Last confirmed on July 9th, 2024 01:15 PM UTC. Leaderboard attempts to update in real-time, but points to be manually confirmed on a weekly basis in case any ERC-721 events are missed."}
								</div>
							</>
						}
						{users &&
