						...
						<div className="col-lg-6">
							<div className="mb-5 mb-lg-0 text-center text-lg-start">
								...
								<div className="d-flex flex-column flex-lg-row align-items-center">
									...
									<a
										className="me-lg-3 mb-4 mb-lg-0 btn btn-secondary"
										href="/collection">
										{"Explore Collection"}
									</a>
								</div>
					...
					<div className="row gx-5 justify-content-center">
						<div className="col-xs-12">
							<div className="h2 fs-3 text-white mb-4">
								{"The Songbirdz NFT collection lives on Base. Each bird starts as an unidentified species with its name and image hidden. Listen to the bird's song, identify it as the correct species, and add it to your birding life list!"}
							</div>
						</div>
					</div>
