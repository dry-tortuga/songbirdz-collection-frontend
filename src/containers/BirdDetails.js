  ...
  return (
    <div id="details-page" className="details-page">
      <Container className="my-4">
        {!bird && <i className="fa-solid fa-spinner fa-spin fa-xl me-2" />}
        {bird && (
          <>
            <Row className="mb-3">
              <Col className="d-flex align-items-center flex-wrap">
                <h1 className="d-flex align-items-center">{bird.name}</h1>
                ...
                <Card>
                  <Row>
                    ...
                    <Card.Body className="col-12 col-sm-6 col-md-8 d-flex flex-column">
                      <Card.Title as="h2" className="ms-3 ms-md-0">
                        {bird.name}
                      </Card.Title>
                      {collection && (
                      ...
                      <ListGroup className="mb-3" variant="flush">
                        <ListGroup.Item className="list-group-item-owner">
                          <span className="w-50 fw-bold">{"Owner"}</span>
                          {bird.owner ? (
                            <AccountOwner
                        ...
                        <ListGroup.Item className="list-group-item-species">
                          <span className="w-50 fw-bold">{"Species"}</span>
                          <span className="w-50 text-center">
                            {bird.species || "ERROR"}
                          </span>
                        </ListGroup.Item>
                        <ListGroup.Item className="list-group-item-song-audio">
                          <span className="w-50 fw-bold">{"Song Audio"}</span>
                          <BirdAudioFile
                      ...
                      {!bird.owner && (
                        <div className="d-grid gap-2">
                          <Button
                            disabled={
                              isIdentifyingBird || txMintNonSmartWallet?.pending
                            }
                            size="lg"
                            variant="info"
                            onClick={() => {
