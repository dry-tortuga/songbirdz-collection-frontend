				...
				setData({
					...
					timestampMessage:
						season === 1
							...
							: "Results last updated on November 20th, 2024 2:30 PM UTC. Leaderboard attempts to update in real-time, but points to be manually confirmed on a weekly basis in case any ERC-721 events are missed."
				});
