    ...
    if (!data && season >= 1) {
      const fetch = async () => {
        ...
        setData({
          ...
          timestampMessage:
            season === 1
              ? "Results are final as of August 31st, 2024 11PM UTC."
              : "Results are final as of November 30th, 2024 11PM UTC.",
          // "Leaderboard attempts to update in real-time, but points to be manually confirmed on a weekly basis in case any ERC-721 events are missed.",
        });
      };
