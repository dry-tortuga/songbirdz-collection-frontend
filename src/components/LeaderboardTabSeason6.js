			...
			{data && (
				<>
					...
					<Row>
						<Col>
							<p>
								{"Runs from September 1st, 2025 to November 30th, 2025 (11 PM UTC). Points should update in real-time, but will be manually confirmed on a weekly basis. Last confirmed on November 10th, 2025 (5 PM UTC)."}
							</p>
							<p>
