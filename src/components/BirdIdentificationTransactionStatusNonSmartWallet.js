...
const BirdIdentificationTransactionStatusNonSmartWallet = (props) => {
  ...
  return (
    <Toast className="fs-6" bg={variant} show={isOpen} onClose={handleClose}>
      <Toast.Header
      ...
      <Toast.Body className="text-white">
        {tx.pending && <i className="fa-solid fa-spinner fa-spin fa-lg me-1" />}
...
export default BirdIdentificationTransactionStatusNonSmartWallet;
